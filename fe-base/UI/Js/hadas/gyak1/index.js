...
//             console.log('continue előtt');
//             continue;
//             console.log('continue után');
//         }
//         console.log('i: '+i+'.  az elozo szam paratlan volt');
//     }
// }
// bAndC();
...
//     console.log('map.d: '+map.d);
//     console.log('map.e: '+map.e);
//     console.log(map);
//     console.log('a map for(var i in map)-al:')
//     for(var i in map){
//         console.log( map[i]);
//     }
//
...
function filterExample() {
    ...
    function oddFilter(value) {
        console.log(value%2);
        return value % 2; //itt csak true-val(1-el) tér vissza ?
    }
}
filterExample();